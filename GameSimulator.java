...
//				
//				while(!isValid(input) && current.canMoveThere(input)){
	...
	public void print(Board b){
		...
		for (int i = 0; i < board.length; i++){
			...
			if (8 < movesCount && (int)(i+8) < movesCount){
				if (i==0){
					System.out.print("\t" + "0" + (int)(i+9) + "." + compMoves.get(i+8) + " " + playerMoves.get(i+8));
				}
				else
